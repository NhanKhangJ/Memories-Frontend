...
const Auth = () => {
    ...
    const history = useHistory() //help us navigate to another page
    
    const handleShowPassword =() =>{
      setShowPassword((prevShowPassword) => !prevShowPassword) // if the previoust show password is something we want to say false and then previous password 
    }
    ...
    const handleSubmit = (e) =>{ 
     ...
     if(isSignup){
       dispatch(signup(formData, history)) //the history will navigate user to the "/" route
     } else {
